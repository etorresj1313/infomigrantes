...
from .views import index,galeria,contacto,agregar,listar,menu,modificar,modlista,eliminar,elimlista,registro,indexc,galeriac,indexi,galeriai,quienes,quienesc,quienesi,loginc,logini
